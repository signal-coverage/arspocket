          ...
          >
            ...
            <div className="flex-1 p-6 overflow-hidden">
              ...
              <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 mb-6">
                {[
                  { label: "Balance", value: "$12,450", change: "+12.4%", up: true },
                  { label: "Income", value: "$3,200", change: "+8.2%", up: true },
                  { label: "Expenses", value: "$1,847", change: "-3.1%", up: false },
              ...
              <div className="bg-[#F8FBF8] dark:bg-[#1A1A25] rounded-xl p-4">
                ...
                <div className="flex items-end gap-2 h-24">
                  {[
                    [52, 38], [68, 42], [48, 55], [75, 40],
                    [62, 48], [80, 44], [90, 52], [72, 38],
                    [85, 46], [94, 50], [78, 44], [100, 48],
                  ].map(([inc, exp], i) => (
